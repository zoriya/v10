...
const error = {
	...
	dialog: cn("flex flex-col gap-3 max-w-72 p-3 rounded-[--spacing(7)] text-white", "transition-[opacity,scale,transform]", "duration-(--media-error-dialog-transition-duration)", "delay-(--media-error-dialog-transition-delay)", "ease-(--media-error-dialog-transition-timing-function)", "group-data-starting-style/error:opacity-0 group-data-starting-style/error:scale-50", "group-data-ending-style/error:opacity-0 group-data-ending-style/error:scale-50", "group-data-ending-style/error:delay-0"),
