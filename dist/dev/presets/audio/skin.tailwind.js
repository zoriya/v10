...
import { menu } from "../../skins/dist/default/default/tailwind/components/menu.js";
...
import { controls, error, playButton, popup, root, slider, time } from "../../skins/dist/default/default/tailwind/audio.tailwind.js";
						...
						children: [
							...
							/* @__PURE__ */ jsxs(TooltipRoot, {
								...
								children: [/* @__PURE__ */ jsx(TooltipTrigger, { render: /* @__PURE__ */ jsx(SeekButton, {
									seconds: -10,
									render: /* @__PURE__ */ jsx(Button, { className: button.seek }),
