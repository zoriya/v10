...
function SettingsMenu() {
	...
	return /* @__PURE__ */ jsxs(MenuRoot, {
		...
		children: [/* @__PURE__ */ jsx(MenuTrigger, {
			...
			className: "media-surface media-popover media-menu media-menu--settings",
		...
		children: [
			...
			/* @__PURE__ */ jsx(ControlsRoot, {
				...
				children: /* @__PURE__ */ jsxs(TooltipProvider, { children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs(TimeSliderRoot, {
									...
									children: [
										...
										/* @__PURE__ */ jsxs("div", {
											className: "media-surface media-thumbnail media-slider__thumbnail",
											children: [
												/* @__PURE__ */ jsx(SliderThumbnail, { className: "media-thumbnail__image" }),
					...
					className: "media-surface media-controls media-controls--secondary",
					children: /* @__PURE__ */ jsxs("div", {
						className: "media-button-group",
						children: [
							/* @__PURE__ */ jsx(CastControl, {}),
							/* @__PURE__ */ jsx(AirPlayControl, {}),
