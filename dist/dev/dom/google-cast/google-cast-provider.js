import { InvalidStateError, NotSupportedError, currentMedia, currentSession, editTracksInfo, getCastContext, getMediaStatus, getPlaylistSegmentFormat, isHls, setCastOptions, setPlaybackRate } from "./utils.js";
import { castFramework, ensureCastFramework, googleCastInstances } from "./registry.js";
import { RemotePlayback } from "./remote-playback.js";
import { isCaptionOrSubtitleTrack } from "@videojs/utils/dom";
//#region src/dom/google-cast/google-cast-provider.ts
/**
...
var GoogleCastProvider = class {
	...
	async load() {
		...
		const castMeta = mediaInfo.customData ?? {};
		...
		const castImage = typeof castMeta.poster === "string" ? castMeta.poster : target?.poster;
...
//# sourceMappingURL=google-cast-provider.js.map