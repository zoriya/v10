...
const time = {
	...
	current: cn("hidden tabular-nums cursor-pointer rounded-[--spacing(1)] outline-2 outline-transparent -outline-offset-2", "transition-[outline-color,outline-offset] duration-100 ease-out", "supports-[corner-shape:squircle]:rounded-[--spacing(4)]", "supports-[corner-shape:squircle]:[corner-shape:squircle]", "focus-visible:outline-current focus-visible:outline-offset-2", "@2xl/media-root:inline"),
