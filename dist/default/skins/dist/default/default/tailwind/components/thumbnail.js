...
//#region ../skins/dist/default/default/tailwind/components/thumbnail.js
const thumbnail = {
	root: cn("group/thumbnail peer/thumbnail pointer-events-none bg-black/90 rounded-[--spacing(3)]"),
	image: cn("block relative overflow-clip rounded-[inherit]", "transition-opacity duration-150 ease-out", "after:absolute after:inset-0 after:rounded-[inherit]", "after:bg-linear-to-t after:from-black/50 after:via-black/10 after:to-black/0", "data-loading:opacity-0"),
