...
import ChevronIcon from "../../icons/dist/react/default/chevron.js";
...
import GearIcon from "../../icons/dist/react/default/gear.js";
...
import QualityIcon from "../../icons/dist/react/default/quality.js";
import RestartIcon from "../../icons/dist/react/default/restart.js";
import SpeechIcon from "../../icons/dist/react/default/speech.js";
import SpeedIcon from "../../icons/dist/react/default/speed.js";
...
import { badge } from "../../skins/dist/default/default/tailwind/components/badge.js";
import { button } from "../../skins/dist/default/default/tailwind/components/button.js";
import { icon, iconFlipped } from "../../skins/dist/default/default/tailwind/components/icon.js";
...
import { bufferingIndicator, buttonGroupEnd, buttonGroupStart, controls, error, inputFeedback, menu, popup, primaryControls, root, secondaryControls, slider, thumbnail, time } from "../../skins/dist/default/default/tailwind/video.tailwind.js";
...
function MenuChevron({ flipped = false }) {
	return /* @__PURE__ */ jsx(ChevronIcon, { className: cn(icon, menu.icon, menu.chevron, flipped ? iconFlipped : void 0) });
}
function SettingsMenu() {
	...
	return /* @__PURE__ */ jsxs(MenuRoot, {
		...
		children: [/* @__PURE__ */ jsx(MenuTrigger, {
			...
			render: /* @__PURE__ */ jsx(Button, { className: cn(button.icon, menu.settingsTrigger) }),
			children: /* @__PURE__ */ jsx(GearIcon, { className: cn(icon, menu.settingsIcon) })
		}), /* @__PURE__ */ jsx(MenuContent, {
			className: menu.settings,
			children: /* @__PURE__ */ jsx(MenuView, {
				className: menu.rootView,
					...
					children: [
						hasQuality ? /* @__PURE__ */ jsxs(MenuRoot, { children: [/* @__PURE__ */ jsx(MenuTrigger, {
							...
							render: (props) => /* @__PURE__ */ jsxs("div", {
								...props,
								children: [
									/* @__PURE__ */ jsx(QualityIcon, { className: cn(icon, menu.icon) }),
									/* @__PURE__ */ jsx("span", { children: t(qualityText) }),
									/* @__PURE__ */ jsxs("span", {
										className: menu.hint,
										children: [/* @__PURE__ */ jsx(MenuItemValue, { className: menu.hintLabel }), /* @__PURE__ */ jsx(MenuChevron, {})]
									})
								]
							})
						}), /* @__PURE__ */ jsxs(MenuContent, {
							className: menu.submenuPanel,
							children: [
								/* @__PURE__ */ jsxs(MenuBack, {
									className: menu.back,
									children: [/* @__PURE__ */ jsx(MenuChevron, { flipped: true }), t(qualityText)]
								}),
								/* @__PURE__ */ jsx(MenuSeparator, { className: menu.separator }),
						...
						hasAudioTrack ? /* @__PURE__ */ jsxs(MenuRoot, { children: [/* @__PURE__ */ jsx(MenuTrigger, {
							...
							render: (props) => /* @__PURE__ */ jsxs("div", {
								...props,
								children: [
									/* @__PURE__ */ jsx(SpeechIcon, { className: icon }),
								...
								/* @__PURE__ */ jsx(MenuRadioGroup, {
									...
									children: audioTrack.options.map((option) => /* @__PURE__ */ jsxs(MenuRadioItem, {
										...
										children: [/* @__PURE__ */ jsx("span", { children: option.label }), /* @__PURE__ */ jsx(MenuItemIndicator, {
											...
											forceMount: true,
											className: menu.indicator,
											children: /* @__PURE__ */ jsx(CheckIcon, { className: icon })
										})]
									}, option.value))
								})
							]
						...
						hasPlaybackRate ? /* @__PURE__ */ jsxs(MenuRoot, { children: [/* @__PURE__ */ jsx(MenuTrigger, {
							...
							render: (props) => /* @__PURE__ */ jsxs("div", {
								...props,
								children: [
									/* @__PURE__ */ jsx(SpeedIcon, { className: cn(icon, menu.icon) }),
						...
						hasCaptions ? /* @__PURE__ */ jsxs(MenuRoot, { children: [/* @__PURE__ */ jsx(MenuTrigger, {
							...
							render: (props) => /* @__PURE__ */ jsxs("div", {
								...props,
								children: [
									/* @__PURE__ */ jsx(CaptionsOffIcon, { className: cn(icon, menu.icon) }),
	...
	return /* @__PURE__ */ jsxs(Container, {
		...
		children: [
			...
			/* @__PURE__ */ jsx(ControlsRoot, {
				"data-controls": "",
				className: controls,
				children: /* @__PURE__ */ jsxs(TooltipProvider, { children: [/* @__PURE__ */ jsxs("div", {
					className: primaryControls,
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs(TimeSliderRoot, {
									...
									children: [
										...
										/* @__PURE__ */ jsxs("div", {
											className: thumbnail.root,
											children: [
												/* @__PURE__ */ jsx(SliderThumbnail, { className: thumbnail.image }),
												/* @__PURE__ */ jsx(SliderValue, {
													type: "pointer",
													className: thumbnail.time
												}),
												/* @__PURE__ */ jsx(SpinnerIcon, { className: cn(icon, thumbnail.spinner) })
											]
										}),
						...
						/* @__PURE__ */ jsxs("div", {
							className: cn(buttonGroupEnd, menu.settingsGroup),
							children: [/* @__PURE__ */ jsxs(TooltipRoot, {
								side: "top",
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs(SeekIndicatorRoot, {
						...
						children: [/* @__PURE__ */ jsx(ChevronIcon, { className: cn(inputFeedback.bubble.icon, inputFeedback.bubble.shownSeek) }), /* @__PURE__ */ jsx(SeekIndicatorValue, { className: inputFeedback.bubble.time })]
					}),
